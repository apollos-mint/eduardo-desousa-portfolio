...
export default function RootNotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20 bg-[#07090e] text-slate-100 relative">
      <div className="max-w-md w-full p-8 rounded-2xl bg-slate-950/90 border border-cyan-500/40 shadow-2xl text-center space-y-6 relative overflow-hidden">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            The requested resource or path does not exist in this deployment.
          </p>
        </div>
