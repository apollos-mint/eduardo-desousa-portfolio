...
const SkillsMatrixScene = dynamic(() => import('@/components/3d/SkillsMatrixScene'));
const DynamicSkillMatrixWidget = dynamic(() => import('@/components/interactive/DynamicSkillMatrixWidget'));
...
export default async function SkillsHubPage({
  ...
  return (
    <div className="w-full relative min-h-screen overflow-hidden">
      {/* Dynamic 3D Neural Competency Constellation Background */}
      <SkillsMatrixScene />
