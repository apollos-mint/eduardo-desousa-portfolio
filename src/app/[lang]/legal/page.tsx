...
const legalContent: Record<Locale, LegalContent> = {
  en: {
    ...
    sections: {
      ...
      privacyController: 'Data Controller: Eduardo de Sousa. Direct contact: desousaej@gmail.com.',
      ...
      privacyRights: 'User Rights & No AI Profiling: Under GDPR Articles 15 through 22, you hold the right to access, rectify, or request erasure of any correspondence sent through the contact hub. No visitor correspondence or telemetry data is processed by artificial intelligence (AI) models, automated profiling algorithms, or third-party LLM training pipelines. No contact information is ever sold or shared.',
  ...
  es: {
    ...
    sections: {
      ...
      privacyController: 'Responsable del Tratamiento: Eduardo de Sousa. Contacto directo: desousaej@gmail.com.',
      ...
      privacyRights: 'Derechos del Interesado y Ausencia de IA: Conforme a los Arts. 15 a 22 del RGPD, usted dispone del derecho de acceso, rectificación y supresión de cualquier información transmitida por el formulario de contacto. Este sitio web no procesa datos de usuarios ni consultas mediante modelos de inteligencia artificial (IA), perfilado automatizado ni entrenamiento de LLMs. Los datos nunca se ceden ni comercializan.',
  ...
  pt: {
    ...
    sections: {
      ...
      privacyRights: 'Direitos dos Titulares e Ausência de IA: Pleno exercício dos direitos de acesso, retificação e eliminação sob os Artigos 15 a 22 do RGPD. Nenhum dado de utilizador ou correspondência é processado por modelos de inteligência artificial (IA) ou perfilamento automatizado.',
  ...
  de: {
    ...
    sections: {
      ...
      privacyController: 'Verantwortlicher: Eduardo de Sousa. E-Mail: desousaej@gmail.com.',
      ...
      privacyRights: 'Betroffenenrechte & Keine KI-Verarbeitung: Recht auf Auskunft, Berichtigung und Löschung gemäß Art. 15–22 DSGVO. Es erfolgt keine Verarbeitung von Benutzerdaten durch Modelle künstlicher Intelligenz (KI), automatisiertes Profiling oder LLM-Pipelines.',
  ...
  fr: {
    ...
    sections: {
      ...
      privacyRights: 'Droits des personnes & Absence de traitement IA : Droits d\'accès, de rectification et d\'effacement selon les articles 15 à 22 du RGPD. Aucune donnée d\'utilisateur n\'est traitée par des modèles d\'intelligence artificielle (IA) ou des algorithmes de profilage automatisé.',
  ...
  nl: {
    ...
    sections: {
      ...
      privacyController: 'Verwerkingsverantwoordelijke: Eduardo de Sousa. Contact: desousaej@gmail.com.',
      ...
      privacyRights: 'Rechten van betrokkenen & Geen AI-verwerking: Volledig recht op inzage, rectificatie en verwijdering conform de artikelen 15 tot 22 AVG. Er worden geen persoonsgegevens of interacties verwerkt via kunstmatige intelligentie (AI) of geautomatiseerde profilering.',
