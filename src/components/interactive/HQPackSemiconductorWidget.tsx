...
export default function HQPackSemiconductorWidget({ currentLocale }: HQPackSemiconductorWidgetProps) {
  ...
  const partners = [
    ...
    { id: 'BOEING', name: 'Boeing', tag: 'Hermetic Aerospace Modules', spec: 'MIL-STD Damping Pass', status: 'Verified' },
    { id: 'AIRBUS', name: 'Airbus', tag: 'Avionic Clean Packaging', spec: 'Nitrogen Purge Seal', status: 'Verified' },
    { id: 'SAMSUNG', name: 'Samsung', tag: '3nm Foundry Transport', spec: 'Zero Outgassing VOC', status: 'Compliant' },
  ...
  const hotspots = [
    ...
    },
    {
      ...
      partner: 'Neways & Samsung 3nm Foundry',
